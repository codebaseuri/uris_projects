...
def recv_by_size(sock, return_type="bytes",timeout=0):
    if timeout > 0:
...
def send_by_size(sock, data):
    ...
    try:
        ...
        print('ERROR: send_by_size with except OSError')
    return data
...
def main_for_test(role):
    ...
    if role == 'srv':
        ...
        send_by_size(cli_s, "1 back:" + data)
        time.sleep(3)
